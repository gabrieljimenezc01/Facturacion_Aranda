...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($user_exists) {
        ...
        $sql = "INSERT INTO clientes (nombre, apellido, direccion, estrato, sector, uso, codigo_medidor, diametro_medidor, fundador, activo) VALUES (:nombre, :apellido, :direccion, :estrato, :sector, :uso, :codigo_medidor, :diametro_medidor, :fundador, :activo)";
