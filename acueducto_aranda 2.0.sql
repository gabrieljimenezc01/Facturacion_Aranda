...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-07-2024 a las 04:58:29
...
(2, 1, 15, 600, 600, 600, 0),
(3, 16, 25, 800, 800, 800, 800),
(4, 26, 35, 1300, 1300, 1300, 1300),
(5, 36, 45, 1500, 1500, 1500, 1500),
(6, 46, 99999999, 2000, 2000, 2000, 2000);
...
--
ALTER TABLE `abonos`
  MODIFY `cod_abono` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
